...
DEFAULT_STARTUP_ALLOWED = (
    "references/entry/00_eva-entry_主入口路由.md",
)
...
SOURCE_OF_TRUTH_RULES = (
    {
        ...
        "allowed": ("references/shared/00_handoff-cards_交接卡字段真源.md",),
    ...
    },
    {
        ...
        "allowed": ("references/shared/03_commercial-constraint-card_商单约束卡真源.md",),
    ...
    },
    {
        ...
        "allowed": (
            "references/asset/00_eva-asset_资产卡协议.md",
        ...
        for phrase in DEFAULT_STARTUP_UNIQUE_PHRASES:
            if phrase in text:
                ...
                if not in_allowed(path, DEFAULT_STARTUP_ALLOWED):
                    errors.append(f"{path_rel}: duplicates default startup phrase; keep startup copy only in Entry")
