...
name: eva-create
description: |
  Eva Create 2.1.3 内容生产入口。处理两条独立分支：短视频、口播稿、视频标题/开头/正文；非虚构自媒体文章、公众号文章、观点长文的新写、续写和修改。不处理朋友圈、微博、小红书短图文、虚构文学、学术论文或专业文书。触发：/eva-create、/eva-shortvideo、/eva-title、/eva-script、做一条短视频、写完整视频稿、写一篇公众号文章、把想法或资料写成文章。
---
