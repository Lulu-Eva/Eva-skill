...
Eva-skill 帮助创作者把模糊想法梳理成更清楚、更有依据的判断，并把它们做成短视频或非虚构自媒体文章。它同时提供话题人群识别、跨学科发散、发布前审核、学习、商单拆解、记忆沉淀与盘点、Eva 数据备份、本地工作流接入、发布后复盘和多元视角补充能力，并能根据当前结果推荐下一步。
...
不会。人设素材或表达文风达到可沉淀状态后，Eva 会先交付完整结果，再问一次要不要保存；只有你明确同意后，才进入保存与校验。涉及隐私字段时还会单独确认。普通聊天、创作、盘点和未完成采集不会因此自动写入记忆库。
